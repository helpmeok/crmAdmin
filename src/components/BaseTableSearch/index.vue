<template>
  <div class="base-table-search">
    <el-form :model="queryParams" ref="queryForm" v-bind="{inline: true,   ...$attrs}" v-on="$attrs">
      <el-form-item :label="item.label" :prop="name" v-for="(item, name) of newQueryFormItems" :key="name">
